...
def transform_fis_to_dashboard():
    ...
    input_path = "/Users/jenkim/Downloads/JEN Group/Project_멀티오케스트레이션/results/v6_pipeline/raw_team_korea.json"
    if not os.path.exists(input_path): input_path = "team_korea_data_sync.json"
    ...
    out = "/Users/jenkim/Downloads/JEN Group/Project_멀티오케스트레이션/results/v6_pipeline/fixed_athletes.json"
